...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_UINT),
                       lzt::image_format_layout_uint, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_SINT),
                       lzt::image_format_layout_sint, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
                       ::testing::Values(ImageSize::min, ImageSize::large)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_UNORM),
                       lzt::image_format_layout_unorm, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
                       ::testing::Values(ImageSize::min, ImageSize::large)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_SNORM),
                       lzt::image_format_layout_snorm, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
                       ::testing::Values(ImageSize::min, ImageSize::large)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_FLOAT),
                       lzt::image_format_layout_float, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
                       ::testing::Values(ImageSize::min, ImageSize::large)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_FLOAT),
                       lzt::image_format_media_layouts, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types_buffer_excluded,
                       ::testing::Values(ImageSize::min, ImageSize::large)));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Combine(::testing::Values(ZE_IMAGE_FORMAT_TYPE_UINT),
                       lzt::image_format_layout_uint, lzt::image_rw_flags,
                       lzt::image_cache_flags, lzt::image_types));
