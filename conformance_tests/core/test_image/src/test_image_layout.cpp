...
INSTANTIATE_TEST_SUITE_P(LayoutTwoKernelsTestsParam,
                         zeImageLayoutTwoKernelsTests,
                         ::testing::Combine(lzt::image_types_buffer_excluded,
