...
LZT_TEST_F(
  ...
  SKIP_IF_SHARED_SYSTEM_ALLOC_UNSUPPORTED();
  RunGivenMemorySizeAndValueWhenAppendingMemoryFillWithWaitEventTest(true, true,
                                                                     false);
}
...
LZT_TEST_P(
    ...
    SKIP_IF_SHARED_SYSTEM_ALLOC_UNSUPPORTED();
    RunGivenCopyBetweenUsmAndSharedSystemUsmAndVerifyCorrect(std::get<0>(GetParam()),
                                                             std::get<1>(GetParam()),
                                                             std::get<2>(GetParam()),
                                                             std::get<3>(GetParam()),
                                                             std::get<4>(GetParam()));
