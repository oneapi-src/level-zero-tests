        ...
        if test_section == "Core":
            ...
            if (test_name.find("MemAdvise")!= -1) or \
                ...
                test_feature_tag = "discrete"
                    ...
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyOnImmediateCmdListThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryOnImmediateCmdListThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyWithHEventThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyWithHEventOnImmediateCmdListThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryWithHEventThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryWithHEventOnImmediateCmdListThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyWithWaitEventThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemoryDeviceHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyWithWaitEventOnImmediateCmdListThenSuccessIsReturned', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryWithWaitEventThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.serach('L0_CTS_zeCommandListAppendMemoryCopyTests_GivenHostMemorySizeAndCopyEngineWhenAppendingMemoryCopyToSharedSystemMemoryWithWaitEventOnImmediateCmdListThenSuccessIsReturnedWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
