        ...
        if test_section == "Core":
            ...
            if (test_name.find("MemAdvise")!= -1) or \
                ...
                test_feature_tag = "discrete"
                    ...
                    (re.search('L0_CTS_TestIncreasingNumberCommandListImmediateAppendCommandListsExpWithEventSynchronize_zeCommandListImmediateAppendCommandListsExpTestsEventSynchronize_GivenCommandListImmediateAppendCommandListsExpAndSyncUsingEventHostSynchronizeThenCallSucceeds', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_TestIncreasingNumberCommandListImmediateAppendCommandListsExpWithEventSynchronize_zeCommandListImmediateAppendCommandListsExpTestsEventSynchronize_GivenCommandListImmediateAppendCommandListsExpWithWaitAndSignalEventsThenVerifyBuffersValid', test_name, re.IGNORECASE)) or \
                    ...
                    (re.search('L0_CTS_zeCommandListCopyEventTest_GivenSuccessiveMemoryCopiesWithEventWhenExecutingOnDifferentQueuesOnImmediateCmdListsAppendCmdListsExpThenCopiesCompleteSuccessfully', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_zeCommandListCopyEventTest_GivenSuccessiveMemoryCopiesWithEventWhenExecutingOnDifferentQueuesOnImmediateCmdListsAppendCmdListsExpThenCopiesCompleteSuccessfullyWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    ...
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidAdvisedSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToAdvisedSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidAdvisedSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToDeviceMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidAdvisedSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToHostMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidAdvisedSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToSharedMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidAdvisedSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidDeviceMemoryWhenAppendingMemoryCopyWithRegionToAdvisedSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidHostMemoryWhenAppendingMemoryCopyWithRegionToAdvisedSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidSharedMemoryWhenAppendingMemoryCopyWithRegionToAdvisedSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_AppendMemoryCopyRegionWithSharedSystem_GivenValidSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToAdvisedSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
