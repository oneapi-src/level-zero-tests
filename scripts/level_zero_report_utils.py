        ...
        if test_section == "Core":
            ...
            if (test_name.find("MemAdvise")!= -1) or \
                ...
                test_feature_tag = "discrete"
                    ...
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToHostMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToSharedMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToDeviceMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidSharedSystemMemoryWhenAppendingMemoryCopyWithRegionToSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidHostMemoryWhenAppendingMemoryCopyWithRegionToSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidSharedMemoryWhenAppendingMemoryCopyWithRegionToSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
                    (re.search('L0_CTS_MemoryCopies_zeCommandListAppendMemoryCopyRegionWithDataVerificationParameterizedTestsWithSharedSystem_GivenValidDeviceMemoryWhenAppendingMemoryCopyWithRegionToSharedSystemMemoryThenSuccessIsReturnedAndCopyIsCorrectWithSharedSystemAllocator', test_name, re.IGNORECASE)) or \
