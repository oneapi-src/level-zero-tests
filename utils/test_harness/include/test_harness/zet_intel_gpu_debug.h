...
typedef enum _zet_debug_regset_type_intel_gpu_t {
  ...
  ZET_DEBUG_REGSET_TYPE_TDR_INTEL_GPU =
      7, ///< The thread dependency register set
  ...
  ZET_DEBUG_REGSET_TYPE_SBA_INTEL_GPU =
      11, ///< The state base address register set
  ...
  ZET_DEBUG_REGSET_TYPE_MODE_FLAGS_INTEL_GPU =
      15, ///< System Routine mode flags register set
  ZET_DEBUG_REGSET_TYPE_DEBUG_SCRATCH_INTEL_GPU =
      16, ///< Debug Scratch register set
...
typedef enum _zet_debug_debug_scratch_intel_gpu_t {
  ZET_DEBUG_DEBUG_SCRATCH_ADDRESS =
      0, ///< VA of scratch area for debugger code injection.
...
typedef enum _zet_debug_sba_intel_gpu_t {
  ...
  ZET_DEBUG_SBA_BINDLESS_SURFACE_INTEL_GPU =
      5, ///< BindlessSurfaceStateBaseAddress
  ZET_DEBUG_SBA_BINDLESS_SAMPLER_INTEL_GPU =
