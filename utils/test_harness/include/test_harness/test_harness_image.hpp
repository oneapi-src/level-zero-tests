...
const auto image_rw_flags = ::testing::Values(0, ZE_IMAGE_FLAG_KERNEL_WRITE);

const auto image_cache_flags =
    ::testing::Values(0, ZE_IMAGE_FLAG_BIAS_UNCACHED);
...
const auto image_format_layout_uint = ::testing::Values(
...
const auto image_format_layout_sint = ::testing::Values(
    ZE_IMAGE_FORMAT_LAYOUT_8, ZE_IMAGE_FORMAT_LAYOUT_8_8,
    ZE_IMAGE_FORMAT_LAYOUT_8_8_8_8, ZE_IMAGE_FORMAT_LAYOUT_16,
    ZE_IMAGE_FORMAT_LAYOUT_16_16, ZE_IMAGE_FORMAT_LAYOUT_16_16_16_16,
    ZE_IMAGE_FORMAT_LAYOUT_32, ZE_IMAGE_FORMAT_LAYOUT_32_32,
    ZE_IMAGE_FORMAT_LAYOUT_32_32_32_32, ZE_IMAGE_FORMAT_LAYOUT_10_10_10_2);
const auto image_format_layout_unorm = ::testing::Values(
    ZE_IMAGE_FORMAT_LAYOUT_8, ZE_IMAGE_FORMAT_LAYOUT_8_8,
    ZE_IMAGE_FORMAT_LAYOUT_8_8_8_8, ZE_IMAGE_FORMAT_LAYOUT_16,
    ZE_IMAGE_FORMAT_LAYOUT_16_16, ZE_IMAGE_FORMAT_LAYOUT_16_16_16_16,
    ZE_IMAGE_FORMAT_LAYOUT_32, ZE_IMAGE_FORMAT_LAYOUT_32_32,
...
const auto image_format_layout_snorm = ::testing::Values(
    ZE_IMAGE_FORMAT_LAYOUT_8, ZE_IMAGE_FORMAT_LAYOUT_8_8,
    ZE_IMAGE_FORMAT_LAYOUT_8_8_8_8, ZE_IMAGE_FORMAT_LAYOUT_16,
    ZE_IMAGE_FORMAT_LAYOUT_16_16, ZE_IMAGE_FORMAT_LAYOUT_16_16_16_16,
    ZE_IMAGE_FORMAT_LAYOUT_32, ZE_IMAGE_FORMAT_LAYOUT_32_32,
    ZE_IMAGE_FORMAT_LAYOUT_32_32_32_32, ZE_IMAGE_FORMAT_LAYOUT_10_10_10_2);
const auto image_format_layout_float = ::testing::Values(
...
const auto image_types = ::testing::Values(
    ZE_IMAGE_TYPE_1D, ZE_IMAGE_TYPE_1D, ZE_IMAGE_TYPE_2D, ZE_IMAGE_TYPE_2DARRAY,
    ZE_IMAGE_TYPE_3D, ZE_IMAGE_TYPE_BUFFER);

const auto image_types_buffer_excluded =
    ::testing::Values(ZE_IMAGE_TYPE_1D, ZE_IMAGE_TYPE_1D, ZE_IMAGE_TYPE_2D,
