...
LZT_TEST(XeCommandQueueDescFlagsToString, InvalidValue) {
...
LZT_TEST(XeCommandQueueDescModeToString, ZE_COMMAND_QUEUE_MODE_SYNCHRONOUS) {
  const ze_command_queue_mode_t d = ZE_COMMAND_QUEUE_MODE_SYNCHRONOUS;
  EXPECT_EQ("ZE_COMMAND_QUEUE_MODE_SYNCHRONOUS",
            level_zero_tests::to_string(d));
}

LZT_TEST(XeCommandQueueDescModeToString, InvalidValue) {
...
LZT_TEST(XeCommandQueueDescPriorityToString,
...
LZT_TEST(XeCommandQueueDescPriorityToString, InvalidValue) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_8) {
  const ze_image_format_layout_t l = ZE_IMAGE_FORMAT_LAYOUT_8;
  EXPECT_EQ("ZE_IMAGE_FORMAT_LAYOUT_8", level_zero_tests::to_string(l));
}

LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_16) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_32) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_8_8) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_8_8_8_8) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_16_16) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_16_16_16_16) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_32_32) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_5_6_5) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_5_5_5_1) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_4_4_4_4) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_Y8) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_NV12) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_YUYV) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_VYUY) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_YVYU) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_UYVY) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_AYUV) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_P010) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_Y410) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_P012) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_Y16) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_P016) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_Y216) {
...
LZT_TEST(XeImageFormatLayoutToString, ZE_IMAGE_FORMAT_LAYOUT_P216) {
...
LZT_TEST(XeImageFormatTypeToString, ZE_IMAGE_FORMAT_TYPE_SNORM) {
...
LZT_TEST(XeImageFormatTypeToString, ZE_IMAGE_FORMAT_TYPE_FLOAT) {
...
LZT_TEST(XeImageFormatTypeToString, InvalidValue) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_R) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_G) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_B) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_A) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_0) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_1) {
...
LZT_TEST(XeImageFormatSwizzleToString, ZE_IMAGE_FORMAT_SWIZZLE_X) {
...
LZT_TEST(XeImageFormatSwizzleToString, InvalidValue) {
...
namespace {
using level_zero_tests::command_bundle;
using level_zero_tests::command_bundle_t;
using level_zero_tests::command_list_mode_t;
} // namespace

class CommandBundleRecordList
    : public ::testing::TestWithParam<command_list_mode_t> {};

LZT_TEST_P(CommandBundleRecordList, ReturnsCorrectHandle) {
  command_bundle b;
  ...
  if (GetParam() == command_list_mode_t::immediate_append_regular ||
    ...
    EXPECT_EQ(b.list, b.record_list());
  }
}
...
LZT_TEST_P(CommandBundleSubmitList, AlwaysReturnsPrimaryList) {
  command_bundle b;
  b.list = reinterpret_cast<ze_command_list_handle_t>(0xDEAD);
  b.append_list = reinterpret_cast<ze_command_list_handle_t>(0xBEEF);
  b.mode = GetParam();
...
LZT_TEST(CommandBundleOperator, MatchesRecordList) {
  ...
  b.list = reinterpret_cast<ze_command_list_handle_t>(0xDEAD);
  b.append_list = nullptr;
  b.mode = command_list_mode_t::regular;

  ze_command_list_handle_t converted = static_cast<ze_command_list_handle_t>(b);
  EXPECT_EQ(b.record_list(), converted);

  b.append_list = reinterpret_cast<ze_command_list_handle_t>(0xBEEF);
  b.mode = command_list_mode_t::immediate_append_regular;
  converted = static_cast<ze_command_list_handle_t>(b);
  EXPECT_EQ(b.record_list(), converted);
}

namespace {

static_assert(command_bundle_t<command_list_mode_t::regular>::has_queue);
...
static_assert(command_bundle_t<command_list_mode_t::immediate>::mode ==
...
static_assert(
    sizeof(command_bundle_t<command_list_mode_t::immediate_append_regular>) <=
    sizeof(command_bundle_t<command_list_mode_t::regular>));
static_assert(sizeof(command_bundle_t<command_list_mode_t::regular>) <=
              2 * sizeof(void *));

} // namespace

LZT_TEST(CommandBundleTRegular, RecordAndSubmitReturnPrimaryList) {
  command_bundle_t<command_list_mode_t::regular> b;
  b.queue = reinterpret_cast<ze_command_queue_handle_t>(0xDEAD);
  b.list = reinterpret_cast<ze_command_list_handle_t>(0xBEEF);

  EXPECT_EQ(b.list, b.record_list());
  EXPECT_EQ(b.list, b.submit_list());
  EXPECT_EQ(b.list, static_cast<ze_command_list_handle_t>(b));
}

LZT_TEST(CommandBundleTImmediate, RecordAndSubmitReturnPrimaryList) {
  command_bundle_t<command_list_mode_t::immediate> b;
  b.list = reinterpret_cast<ze_command_list_handle_t>(0xC0FFEE);
