...
__kernel void blackscholes(const float riskfree, const float volatility, global const float* T, global const float* X, global const float* S, global float* Call, global float* Put) {
